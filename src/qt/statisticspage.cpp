...
void StatisticsPage::updateStatistics()
{
    ...
    int64_t volume = ((pindexBest->nMoneySupply)/210000000);
    ...
    {
        ui->heightBox->setText("<b><font color=\"#0e2034\">" + height + "</font></b>");
    } else {
    ...
    if(nHeight < 200)
        {
            ui->rewardBox->setText("<b><font color=\"#0e2034\">0 PoW+ 1% PoS p.a.</font></b>");
        }
        else
        {
            ui->rewardBox->setText("<b><font color=\"#0e2034\">25 PoW+ 1% PoS p.a.</font></b>");
        }


    if(0 > stakeminPrevious)
    {
        ui->minBox->setText("<b><font color=\"#0e2034\">" + stakemin + "</font></b>");
    } else {
    ui->minBox->setText(stakemin);
    }
    if(0 > stakemaxPrevious)
    {
        ui->maxBox->setText("<b><font color=\"#0e2034\">" + stakemax + "</font></b>");
    } else {
    ...
    {
        ui->cBox->setText("<b><font color=\"#0e2034\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->diffBox->setText("<b><font color=\"#0e2034\">" + hardness + "</font></b>");
    } else {
    ...
    {
        ui->diffBox2->setText("<b><font color=\"#0e2034\">" + hardness2 + "</font></b>");
    } else {
    ...
    {
        ui->pawrateBox->setText("<b><font color=\"#0e2034\">" + pawrate + " MH/s</font></b>");
    } else {
    ...
    {
        ui->localBox->setText("<b><font color=\"#0e2034\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->connectionBox->setText("<b><font color=\"#0e2034\">" + QPeers + "</font></b>");
    } else {
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#0e2034\"> 210,000,000 BTP </font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"#0e2034\"> 210,000,000 BTP </font></b>");
    }
