...
!define URL http://www.BitcoinPRO.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/BitcoinPRO.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\BitcoinPRO-qt.exe
...
OutFile BitcoinPRO-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/BitcoinPRO-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/BitcoinPROd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\BitcoinPRO.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\BitcoinPRO-qt.exe
